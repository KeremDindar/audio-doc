...
class SettingsViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        gradientView.addSubview(premiumCard)
    ...
    private func setupGradientBackground() {
        ...
        // Need to set the frame in viewDidLayoutSubviews
    ...
    private func setupConstraints() {
        ...
        diamondImageView.snp.makeConstraints { make in
            ...
            make.leading.equalTo(premiumTitleLabel.snp.trailing).offset(8)
    ...
    @objc private func premiumCardTapped() {
        ...
        // Handle premium subscription action
    }
